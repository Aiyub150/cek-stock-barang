...
<body class="align">
    ...
    <div class="grid">
      ...
      <form action="{{ route('register') }}" method="POST" class="form login">
        ...
        <div class="form__field">
          <label for="alamat"><svg class="icon">
                <use xlink:href="#icon-user"></use>
            </svg><span class="hidden">Alamat</span></label>
          <input id="alamat" type="text" name="alamat" class="form__input" placeholder="Alamat" required>
        </div>

        <div class="form__field">
          <label for="level"><svg class="icon">
              <use xlink:href="#icon-lock"></use>
            </svg><span class="hidden">Level</span></label>
          <select id="level" name="level" class="form__input" required>
      ...
      @if ($errors->has('register'))
        <p style="color: red;">{{ $errors->first('register') }}</p>
      @endif
